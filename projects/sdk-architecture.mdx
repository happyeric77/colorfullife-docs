...
- [From a React hook to a framework-agnostic SDK core](/journal/2026/03/06/from-a-react-hook-to-a-framework-agnostic-sdk-core)
- [Designing unified error handling for a public SDK](/journal/2026/02/11/designing-unified-error-handling-for-a-public-sdk)
- [Modernizing wallet connectivity with EIP-6963](/journal/2026/04/01/modernizing-wallet-connectivity-with-eip-6963)
- [Backend-driven configuration for an embeddable SDK](/journal/2026/02/20/backend-driven-configuration-for-an-embeddable-sdk)
